...
class MultiFloorRaidStatChangeExcel(object):
    ...
    @classmethod
    def GetRootAsMultiFloorRaidStatChangeExcel(cls, buf, offset):
...
def MultiFloorRaidStatChangeExcelAddStatType_(builder, StatType_): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(StatType_), 0)
def MultiFloorRaidStatChangeExcelStartStatType_Vector(builder, numElems): return builder.StartVector(4, numElems, 4)
