...
class WebEventSeasonExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAsWebEventSeasonExcelTable(cls, buf, offset):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = WebEventSeasonExcelTable()
        x.Init(buf, n + offset)
        return x

    # WebEventSeasonExcelTable
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.WebEventSeasonExcel import WebEventSeasonExcel
            obj = WebEventSeasonExcel()
