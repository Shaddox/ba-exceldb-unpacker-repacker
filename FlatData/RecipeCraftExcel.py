...
class RecipeCraftExcel(object):
    ...
    @classmethod
    def GetRootAsRecipeCraftExcel(cls, buf, offset):
...
def RecipeCraftExcelAddParcelType_(builder, ParcelType_): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(ParcelType_), 0)
def RecipeCraftExcelStartParcelType_Vector(builder, numElems): return builder.StartVector(4, numElems, 4)
